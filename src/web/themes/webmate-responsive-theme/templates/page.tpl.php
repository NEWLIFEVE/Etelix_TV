  ...
  <div id="inner_header_wrapper">
    ...
    <?php if (theme_get_setting('social_links', 'webmate_responsive_theme')): ?>
      <div class="social-icons">
       <ul>
        <li><a href="/"><img src="<?php print base_path() . drupal_get_path('theme', 'webmate_responsive_theme') . '/images/facebook.png'; ?>" alt="Facebook"/></a></li>
        <li><a href="/"><img src="<?php print base_path() . drupal_get_path('theme', 'webmate_responsive_theme') . '/images/twitter.png'; ?>" alt="Twitter"/></a></li>
       </ul>
      </div>
    <?php endif; ?>
  ...
  <div id="container">
    ...
    <div id="content">
      ...
      <section id="post-content" role="main">
        ...
        <?php 
            $bienvenido="<h2>Bienvenido a EtelixTV</h2> ";
            if(isset($_SESSION))
            {
              print $bienvenido;
